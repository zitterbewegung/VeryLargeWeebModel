...
def main():
    ...
    if dataset_type == 'uavscenes':
        ...
        uavscenes_cfg = UAVScenesConfig(
            ...
            pose_dim=ds_cfg.get('pose_dim', 13),
            base_frame_interval=ds_cfg.get('base_frame_interval', 0.1),
            max_linear_velocity=ds_cfg.get('max_linear_velocity', 20.0),
            max_angular_velocity=ds_cfg.get('max_angular_velocity', 6.28),
            max_points=ds_cfg.get('max_points', 100000),
            use_intensity=ds_cfg.get('use_intensity', True),
            use_semantic_labels=ds_cfg.get('use_semantic_labels', False),
        ...
        val_uavscenes_cfg = UAVScenesConfig(
            ...
            normalize_pose_to_first_frame=uavscenes_cfg.normalize_pose_to_first_frame,
            pose_dim=uavscenes_cfg.pose_dim,
            base_frame_interval=uavscenes_cfg.base_frame_interval,
            max_linear_velocity=uavscenes_cfg.max_linear_velocity,
            max_angular_velocity=uavscenes_cfg.max_angular_velocity,
            max_points=uavscenes_cfg.max_points,
            use_intensity=uavscenes_cfg.use_intensity,
            use_semantic_labels=uavscenes_cfg.use_semantic_labels,
